            ...
            <div class="sidebar-brand-icon" >
                <div class="login-container">
                    ...
                    {{-- <p style="margin-left: 90px; margin-top: -50px; color:white; font-weight: bold; font-family: poppins_bold;">
                        TAILOR HUB</p> --}}
                    <p style="color:white; font-weight: bold; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('guru.konten.index') }}">
                            <i class="fas fa-book"></i>
                            <span>Manajemen Konten</span></a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('guru.kuis.index') }}">
                            <i class="fas fa-book"></i>
                            <span>Manajemen Kuis</span></a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('guru.forum_diskusi.index') }}">
                            <i class="fas fa-book"></i>
